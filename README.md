...
| [`platform/agent-platform`](platform/agent-platform/) | 以 OpenHands Agent Canvas 為範本的自託管多 agent 工作平台：統一 Web UI、Cocoon 隔離執行（M0 契約測試開發中） | React, Python, PostgreSQL, Cocoon（規劃） |
