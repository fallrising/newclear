...
**目前剩餘 17 項：近期收尾 6 項，後續驗證／擴充 11 項。此清單內完成 1 項。** 先按近期收尾推進；後續項目保留原 SDD 範圍，不代表立即對 VPS 執行所有變更。

下一項：**ERU-002**，於 2026-09-24 11:25:06 UTC 後回收觀測。等待期間可先準備 ERU-007 的本機取樣／判讀工具，不干擾現有 run。近期 7 項完成表示這批收尾工作完成，不等同原 SDD 全部 V01–V11 或完整 HA 已通過。
