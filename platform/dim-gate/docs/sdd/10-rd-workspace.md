...
版本：WS-SDD revision 1 · 狀態：W1 已驗收合併；W2 已實作、完整驗收待完成，固定證據見 [STATUS](../STATUS.md)；後續未實作部分見[能力對照](13-capability-map.md)。共用需求與模型以 [09](09-shared-workspaces.md) 為準，驗收以 [14](14-workspace-delivery.md) 為準。
