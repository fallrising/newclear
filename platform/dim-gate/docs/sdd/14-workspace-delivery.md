...
版本：WS-SDD revision 1 · 狀態：W1 已驗收合併；W2 已實作、完整驗收待完成；W3–W5 尚未實作。固定驗證、獨立 review 與接受／合併狀態見 [STATUS](../STATUS.md) 和 [PLAN](../../../../.team/PLAN.md)。本文定義新驗收 ID，不修改已 ACCEPTED 的 M0–M5。
