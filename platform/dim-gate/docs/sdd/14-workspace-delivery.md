...
版本：WS-SDD revision 1 · 狀態：W1–W5 已驗收合併（2026-09-24）；本章列出的 AC-WS-01–18 均屬既有交付範圍。產品行為依本章，當前證據與接受決策見 [STATUS](../STATUS.md) 和 [PLAN](../../../../.team/PLAN.md)。後續能力尚未形成 W6 或 AC-WS-19；先由產品 owner 選定範圍並建立新驗收契約。
