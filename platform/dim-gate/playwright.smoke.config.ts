...
export default defineConfig({
  ...base,
  testIgnore: [],
  testMatch: ['foundation.spec.ts', 'm5-browser-smoke.spec.ts', 'w1-workspaces.spec.ts'],
  grep: /production demo shell guards|additional browser complete visible Guide story|W1 extra browser/,
