...
export default defineConfig({
  ...base,
  testIgnore: [],
  testMatch: ['foundation.spec.ts', 'm5-browser-smoke.spec.ts', 'w1-workspaces.spec.ts', 'w2-browser-smoke.spec.ts', 'w3-browser-smoke.spec.ts', 'w4-browser-smoke.spec.ts'],
  grep: /production demo shell guards|additional browser complete visible Guide story|W1 extra browser|W2 extra browser|W3 extra browser|W4 extra browser/,
