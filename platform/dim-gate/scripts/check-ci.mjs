...
for (const gate of ['pnpm install --frozen-lockfile', 'pnpm lint', 'pnpm typecheck', 'pnpm test', 'pnpm check:docs', 'pnpm check:contracts', 'pnpm check:architecture', 'pnpm build --mode demo', 'pnpm test:e2e']) {
