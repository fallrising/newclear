...
export function registerCoreSessionContracts({ z, d, w, s, read, command }: ContractContext) {
  ...
  read('/dashboard', 'getDashboard', s.DashboardView, 'M0', d.dashboardQuerySchema)
