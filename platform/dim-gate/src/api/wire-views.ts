...
export const entitySearchHitSchema = z.strictObject({ type: z.enum(['application', 'environment', 'ci', 'request', 'release', 'incident']), id: idSchema, title: z.string().min(1).max(500), route: z.string().startsWith('/') })
