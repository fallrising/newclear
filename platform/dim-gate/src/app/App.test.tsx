...
beforeEach(() => {
  ...
  client.getGuide.mockImplementation(async () => ({ logicalClock: client.clock, storeRevision: client.commandCount, sessionId: 'session-test', seedVersion: 'dim-gate-m1-v1', schemaVersion: 1, pendingTasks: 0, commandCount: client.commandCount }))
