...
const actions: Record<Center, readonly string[]> = {
  ...
  admin: ['app.read', 'environment.read', 'ci.read', 'release.read', 'observation.read', 'request.read', 'incident.read', 'catalog.read', 'catalog.write', 'catalog.publish', 'navigation.write', 'model.write', 'access.write', 'feature.write', 'audit.read', 'integration.read', 'integration.test', 'capacity.read'],
}
