...
export function ApplicationDetailRoute({ client = defaultClient, canReadResources = false, canReadServiceDelivery = false }: { client?: ApplicationClient; canReadResources?: boolean; canReadServiceDelivery?: boolean }) {
...
export function EnvironmentDetailRoute({ client = defaultClient, canReadResources = false, canReadServiceDelivery = false }: { client?: ApplicationClient; canReadResources?: boolean; canReadServiceDelivery?: boolean }) {
