...
1. `products/hai-taskboard/.team/PLAN.md` and `products/hai-taskboard/AGENTS.md`.
...
files disagree, `products/hai-taskboard/.team/PLAN.md` plus Git/SQLite authority rules win; record the discrepancy rather
