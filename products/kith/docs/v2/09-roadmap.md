...
- 禁止：任何聊天功能；修改後端。
- 狀態：`VERIFIED`（施工圖：[milestones/W0.md](milestones/W0.md)；實作 PR #PR_NUMBER，全套 run `20260924-065045-dc89e25`：`E2E-W0-01` desktop／mobile、`E2E-W0-02` 通過，`e2e:validate` ok）。
